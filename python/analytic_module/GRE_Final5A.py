...
#releted DATA        
        related_data ={
        "Question":"How I am performing in GRE Final Exam attempts?",
        "Answer_Type":"normal_graph",
        "type":"graph",
        "Description": "This graphs show users GRE Performance in final exam attempts. According to available data your final attempts average score is <b>"+str(total)+"</b>." ,
        "Related_Data":{
            "set":"#5A",
