...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2015 at 10:23 AM
...
INSERT INTO `comp_exam_mapping` (`id`, `form_code`, `table_name`, `exam_name`) VALUES
(2, '50102', 'comp_toefl', 'TOEFL exam'),
(22, '50202', 'comp_toefl', 'TOEFL exam'),
(23, '501010101', 'comp_gre', 'GRE exam'),
(24, '501010102', 'comp_gre', 'GRE exam'),
(25, '501010103', 'comp_gre', 'GRE exam'),
(26, '5010301', 'comp_gate', 'GATE exam'),
(27, '5010302', 'comp_gate', 'GATE exam'),
(28, '5010303', 'comp_gate', 'GATE exam'),
(29, '5010201', 'comp_gre', 'GRE exam'),
(30, '5010202', 'comp_gre', 'GRE exam'),
(31, '5020301', 'comp_gate', 'GATE exam'),
(32, '5020302', 'comp_gate', 'GATE exam'),
(33, '5020303', 'comp_gate', 'GATE exam');
...
(16, 5, '10201', '../forms/form_data/mum_sem_1.json', '../forms/form_security/mum_semester.js', 0, 'CBSE-10th', '2015-04-29 08:32:48'),
(17, 5, '20101', '{\\"Append\\":\\"$(document).ready( function(){\\\\r\\\\n total_length = $(\\''#\\''+obj[\\''form_name\\'']+\\'' input\\'').length;\\\\r\\\\n var total_marks =0;\\\\r\\\\n var cgpa = 0;\\\\r\\\\n grade_point_arr = {\\''A1\\'':10,\\''A2\\'':9,\\''B1\\'':8,\\''B2\\'':7,\\''C1\\'':6,\\''C2\\'':5,\\''D\\'':4,\\''E1\\'':0,\\''E2\\'':0};\\\\r\\\\n \\\\/\\\\/alert(total_length);\\\\r\\\\n \\\\r\\\\n for(i=1; i\\\\u003C=total_length; i++){\\\\r\\\\n if($(\\''#data_field_\\''+i).val()){ \\\\r\\\\n res = ($(\\''#data_field_\\''+i).val()).toUpperCase();\\\\r\\\\n if(res in grade_point_arr){\\\\r\\\\n grade_point = grade_point_arr[res];\\\\r\\\\n $(\\''#Fld_Grade_Point_\\''+i).html(grade_point);\\\\r\\\\n total_marks +=parseFloat($(\\''#Fld_Grade_Point_\\''+i).text());\\\\r\\\\n cgpa = (total_marks\\\\/total_length).toFixed(2);\\\\r\\\\n }\\\\r\\\\n }\\\\r\\\\n }\\\\r\\\\n \\\\r\\\\n \\\\/\\\\/alert(cgpa);\\\\r\\\\n $(\\''#\\''+obj[\\''form_name\\'']+\\'' #final\\'').html(cgpa);\\\\r\\\\n \\\\r\\\\n \\\\r\\\\n $(\\''#\\''+obj[\\''form_name\\'']+\\'' tr td\\'').on(\\''keyup\\'',\\''input\\'', function(e){\\\\r\\\\n var total_credit = 0;\\\\r\\\\n var grade_point = 0;\\\\r\\\\n total_marks = 0;\\\\r\\\\n code =$(this).attr(\\''name\\'');\\\\r\\\\n if($(this).val()){\\\\r\\\\n res = ($(this).val()).toUpperCase(); \\\\r\\\\n if (res.length\\\\u003C=obj[\\''Field_\\''+code][\\''input_length\\'']){\\\\r\\\\n var function_type = obj[\\''Field_\\''+code][\\''input_type\\''];\\\\r\\\\n if (eval(function_type+\\''(\\\\\\"\\''+res+\\''\\\\\\",\\\\\\"\\''+obj[\\''Field_\\''+code][\\''limit\\'']+\\''\\\\\\")\\'')) { \\\\r\\\\n \\\\r\\\\n grade_point_arr = {\\''A1\\'':10,\\''A2\\'':9,\\''B1\\'':8,\\''B2\\'':7,\\''C1\\'':6,\\''C2\\'':5,\\''D\\'':4,\\''E1\\'':0,\\''E2\\'':0};\\\\r\\\\n if(res in grade_point_arr){\\\\r\\\\n grade_point = grade_point_arr[res];\\\\r\\\\n $(\\''#Fld_Grade_Point_\\''+code).html(grade_point);\\\\r\\\\n total_marks = 0;\\\\r\\\\n for (i=1; i\\\\u003C=obj[\\''Total_Fields\\'']; i++) {\\\\r\\\\n total_marks +=parseFloat($(\\''#Fld_Grade_Point_\\''+i).text());\\\\r\\\\n }\\\\r\\\\n cgpa = (total_marks\\\\/obj[\\''Total_Fields\\'']).toFixed(2);\\\\r\\\\n $(\\''#final\\'').html(cgpa);\\\\r\\\\n }\\\\r\\\\n }else if((res.length\\\\u003Eobj[\\''Field_\\''+code][\\''input_length\\'']) && (e.keyCode\\\\u003E64 && e.keyCode\\\\u003C91) || (e.keyCode\\\\u003E95 && e.keyCode\\\\u003C106) || (e.keyCode\\\\u003E47 && e.keyCode\\\\u003C58)){\\\\r\\\\n warning(\\''invalid\\'');\\\\r\\\\n $(this).val(\\''\\'');\\\\r\\\\n }\\\\r\\\\n }else{\\\\r\\\\n $(\\''#Fld_Grade_Point_\\''+code).html(grade_point);\\\\r\\\\n $(\\''#final\\'').html(cgpa);\\\\r\\\\n warning(\\''length\\'');\\\\r\\\\n $(this).val(\\''\\'');\\\\r\\\\n }\\\\r\\\\n }else{\\\\r\\\\n $(\\''#Fld_Grade_Point_\\''+code).html(grade_point);\\\\r\\\\n for (i=1; i\\\\u003C=obj[\\''Total_Fields\\'']; i++) {\\\\r\\\\n total_marks +=parseFloat($(\\''#Fld_Grade_Point_\\''+i).text());\\\\r\\\\n }\\\\r\\\\n cgpa = (total_marks\\\\/obj[\\''Total_Fields\\'']).toFixed(2);\\\\r\\\\n $(\\''#final\\'').html(cgpa);\\\\r\\\\n }\\\\r\\\\n });\\\\r\\\\n });\\\\r\\\\n \\",\\"form_data\\":{\\"form_name\\":\\"CBSE-12th\\",\\"Field_Parameter\\":3,\\"Total_Fields\\":7,\\"header_field\\":[\\"Subject\\",\\"Grade\\",\\"Grade Point\\"],\\"field_name\\":[\\"Subject\\",\\"Grade\\",\\"Grade_Point\\"],\\"Field_1\\":{\\"Subject\\":\\"English Core\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_2\\":{\\"Subject\\":\\"Mathematics\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_3\\":{\\"Subject\\":\\"Physics\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_4\\":{\\"Subject\\":\\"Chemistry\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_5\\":{\\"Subject\\":\\"Work Experience\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_6\\":{\\"Subject\\":\\"Physical & Health Education\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]},\\"Field_7\\":{\\"Subject\\":\\"General Studies\\",\\"Grade\\":\\"text\\",\\"Grade_Point\\":\\"0\\",\\"input_length\\":\\"2\\",\\"input_type\\":\\"grade\\",\\"limit\\":[\\"A1\\",\\"A2\\",\\"B1\\",\\"B2\\",\\"C1\\",\\"C2\\",\\"D\\",\\"E1\\",\\"E2\\"]}}}', NULL, 0, 'CBSE-12th', '2015-04-21 08:00:44'),
...
(13, 'siddhesh', 'krT3QxCML5fGPDb', 'p6ucrqYXHZ');
...
(5, 'krT3QxCML5fGPDb', '5010201', '1', '2015-04-16', '56', '156', NULL, NULL, NULL, '2015-04-30 19:06:57', NULL, NULL, NULL, NULL, NULL, NULL, '212');
...
(2, 'krT3QxCML5fGPDb', '1', '{"Total_Edited_Forms":1,"Edited_Form_List":["301010101"]}', '../UserJson/Completed/krT3QxCML5fGPDb.json', '../UserJson/Partial/krT3QxCML5fGPDbp.json');
...
(3, 'krT3QxCML5fGPDb', '{"Parameter":{"Total_Simple_Exam_Field":6,"Total_Comp_Exam_Field":1},"Simple_Exam":[{"form_type":"undergraduate","Form_Code":"301010101","Table_name":"user_record"},{"form_type":"undergraduate","Form_Code":"301010102","Table_name":"user_record"},{"form_type":"undergraduate","Form_Code":"301010103","Table_name":"user_record"},{"form_type":"undergraduate","Form_Code":"301010104","Table_name":"user_record"},{"form_type":"undergraduate","Form_Code":"301010105","Table_name":"user_record"},{"form_type":"undergraduate","Form_Code":"301010106","Table_name":"user_record"}],"Comp_Exam":[{"form_type":"GRE","Form_Code":"5010201","Table_name":"comp_gre","Attempt":1}]}', '2015-05-01 11:19:24');
...
(10, 'krT3QxCML5fGPDb', '301010101', NULL, 'a', 'a', 'p', 'a', 'o', 'a', 'a', '2015-05-03 20:38:16', NULL, NULL, NULL, NULL, 0, '8.54'),
(11, 'krT3QxCML5fGPDb', '301010102', NULL, 'a', 'o', 'o', 'p', 'a', 'b', 'a', '2015-05-01 11:02:05', NULL, NULL, NULL, NULL, 0, '8.22'),
(12, 'krT3QxCML5fGPDb', '301010103', NULL, 'o', 'c', 'c', 'e', 'a', 'o', NULL, '2015-05-01 11:02:42', NULL, NULL, NULL, NULL, 0, '7.89'),
(13, 'krT3QxCML5fGPDb', '301010104', NULL, 'o', 'o', 'a', 'a', 'a', 'a', NULL, '2015-05-01 11:03:14', NULL, NULL, NULL, NULL, 0, '9.36'),
(14, 'krT3QxCML5fGPDb', '301010105', 'a', 'a', 'o', 'o', 'a', 'b', 'c', 'p', '2015-05-01 11:03:31', 'a', 'a', 'a', NULL, 0, '8.87'),
(15, 'krT3QxCML5fGPDb', '301010106', 'c', 'a', 'o', 'o', 'o', 'p', 'a', 'b', '2015-05-01 11:19:24', 'd', 'a', NULL, NULL, 0, '8.44');
