...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <?php
            if($userType == "student"){
              echo '<li id="exam"><a href="exam.php"><i class="fa fa-file-text-o"></i><span>Exam</span></a></li>';
              echo '<li><a href="analytics.php"><i class="fa fa-pie-chart"></i><span> Analytics</span></a></li>';
            }
            ?>
